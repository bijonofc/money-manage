...
const getDetails = async() => {
    ...
    if (props.id != null) {
        detailModal.value?.showLoader(true, appsbdUtls.translateGettext('Loading type', { type: 'Transaction' }));
        const response = await transactionStore.getDetail({id: props.id})
        if (response.status) {
